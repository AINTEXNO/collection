...
@section('title') Редактирование акции @endsection
...
@section('content')
            ...
            <nav class="flex mt-4 mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-600" fill="currentColor" stroke-width="1" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2">Редактирование акции</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <section class="w-full h-[calc(100vh-200px)] flex justify-center items-center">
        <div class="container">
            <form action="{{ route('promotions.update', ['promotion' => $promotion->id]) }}" method="POST" class="w-full flex flex-col items-start" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                @if(session()->has('updated'))
                    <div class="w-full p-4 mb-4 text-sm text-blue-700 font-normal bg-blue-100 rounded-lg" role="alert">
                        <span class="font-normal">Данные акции успешно изменены</span>
                    </div>
                @endif
                    ...
                    <div class="w-1/2 border border-gray-150 rounded-sm box-border py-5 px-6">
                        ...
                        <div class="w-full flex flex-col items-start">
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <input type="text" name="title" id="title" class="@error('title') border-red-400 @enderror w-full border py-1.5 px-3 mt-1 text-base rounded-sm" placeholder="Наименование акции" value="{{ $promotion->title }}">
                            ...
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <input type="file" name="image" id="image" class="@error('image') border-red-400 @enderror w-full border py-1.5 px-3 mt-1 text-base rounded-sm" placeholder="Фотография акции">
                            ...
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <textarea name="description" id="description" class="@error('description') border-red-400 @enderror resize-none w-full h-32 border box-border py-1.5 px-3 mt-1 rounded-sm" placeholder="Описание акции">{{ $promotion->description }}</textarea>
                    ...
                    <div class="w-1/2 border border-gray-150 rounded-sm box-border py-5 px-6 ml-6">
                        ...
                        <div class="w-full flex flex-col items-start">
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <input type="date" name="start_date" id="start_date" class="@error('start_date') border-red-400 @enderror w-full border py-1.5 px-3 mt-1 text-base rounded-sm" placeholder="Дата начала акции" value="{{ $promotion->start_date }}">
                            ...
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <input type="date" name="end_date" id="end_date" class="@error('end_date') border-red-400 @enderror w-full border py-1.5 px-3 mt-1 text-base rounded-sm" placeholder="Наименование товара" value="{{ $promotion->end_date }}">
                            ...
                            <div class="w-full flex mb-3">
                                ...
                                <div class="w-full flex flex-col items-start">
                                    <input type="number" name="discount" id="discount" min="1" max="100" step="1" class="@error('discount') border-red-400 @enderror w-1/2 border py-1.5 px-3 mt-1 text-base rounded-sm" placeholder="Скидка" value="{{ $promotion->discount }}">
                                    @error('discount')<p class="text-base text-red-400 my-2">{{ $message }}</p>@enderror
                                </div>
                            </div>
                            <div class="w-full flex justify-end">
                                <button type="submit" class="px-6 py-2.5 text-sm bg-gray-200 text-gray-600 rounded-full uppercase text-black mt-7">Изменить акцию</button>
                            </div>
                        </div>
                    </div>
                </div>
